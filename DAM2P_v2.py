...
def main():
    ...
    parser.add_argument("--hnn", default=128, type=int, help="The number of neurons in the hidden layer used in LSTMs.")
    parser.add_argument("--dnn", default=300, type=int, help="The number of neurons in the hidden layer used in deep feedforward layers.")
